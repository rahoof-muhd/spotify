...
import f3 from "/src/assets/trt.jpeg"
                        ...
                        <div className=' px-4 laptopts:flex laptopts:flex-row items-center text-white tablets:flex tablets:flex-row mobiles:flex mobiles:flex-col '>
                            ...
                            <div className=' laptopts:py-24 px-6 mobiles:pb-1'>
                                <p className='px-1 font-bold font-sans'>
                                    Playlist</p>
                                <p className=' font-bold text-7xl font-sans'>Tamil Road Trips</p>
                                <br></br>
                            ...
                            <div className='px-20 '>
                                ...
                                <div class="grid grid-rows-7 grid-flow-col gap-4 p-3">
                                    ...
                                    <div className='flex font-semiboldflex gap-3'>
                                        <p className='text-xl  text-white '>4:56</p>
                                    </div>
                                    <div className='flex font-semiboldflex gap-3'>
                                    <p className='text-xl  text-white '>2:54</p>
                                    </div>
                                    <div className='flex font-semiboldflex gap-3'>
                                    <p className='text-xl  text-white '>3:50</p>
                                    </div>
                                    <div className='flex font-semiboldflex gap-3'>
                                    <p className='text-xl  text-white '>4:58</p>
                                    </div>
                                    <div className='flex font-semiboldflex gap-3'>
                                    <p className='text-xl  text-white '>3:28</p>
                                    </div>
                                    <div className='flex font-semiboldflex gap-3'>
                                    <p className='text-xl  text-white '>4:18</p>
                                    </div>
                                    <div className='flex font-semiboldflex gap-3'>
                                    <p className='text-xl  text-white '>5:28</p>
                                    </div>
