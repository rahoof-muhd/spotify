    ...
    return (
        ...
        {/* <div className="pt-2 absolute "> */}
            <div className="navbar bg-neutral-900 grid gap-4 p-4 box-border rounded-lg font-bold font-sans absolute w-full ">
                ...
                <Link to="/homenew" className="no-underline  text-white flex "><img src={homes} alt="" className="h-8 "/><p className=" pt-2 pl-4 text-l  ">Home</p></Link>
                </div>

                <div className="opacity-60 hover:opacity-100 duration-200">
                <Link to="/searchnew" className="no-underline text-white  flex"><img src={search} alt="" className="h-8 "/><p className=" pt-2 pl-4 text-l ">Search</p></Link> 
                </div>
            {/* </div> */}
